...
namespace FirstBoilerPlateApp.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = FirstBoilerPlateAppConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(FirstBoilerPlateAppDbContext context)
        {
            _context = context;
        }
