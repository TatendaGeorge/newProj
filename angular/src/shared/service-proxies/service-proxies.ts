...
@Injectable()
export class AppEventServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getList(includeCanceledEvents: boolean | undefined): Observable<EventListDtoListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/GetList?";
    ...
    create(body: CreateEventInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    cancel(body: GuidEntityDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/Cancel";
        url_ = url_.replace(/[?&]$/, "");
    ...
    register(body: GuidEntityDto | undefined): Observable<EventRegisterOutput> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/Register";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getDetail(id: string | undefined): Observable<EventDetailOutput> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/GetDetail?";
        if (id === null)
    ...
    cancelRegistration(body: GuidEntityDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AppEvent/CancelRegistration";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class EmployeeServicesServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    create(body: CreateEmployeeInput | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getDetail(id: string | undefined): Observable<EmployeeListDto> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/GetDetail?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGetDetail(response: HttpResponseBase): Observable<EmployeeListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    updateEmployee(employeeId: string | undefined, body: UpdateEmployeeDto | undefined): Observable<UpdateEmployeeDto> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/UpdateEmployee?";
        if (employeeId === null)
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<UpdateEmployeeDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<UpdateEmployeeDto>><any>_observableThrow(response_);
        }));
    }

    protected processUpdateEmployee(response: HttpResponseBase): Observable<UpdateEmployeeDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        return _observableOf<UpdateEmployeeDto>(<any>null);
    }
    ...
    delete(employeeId: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/Delete?";
        if (employeeId === null)
            throw new Error("The parameter 'employeeId' cannot be null.");
        else if (employeeId !== undefined)
            url_ += "employeeId=" + encodeURIComponent("" + employeeId) + "&";
     ...
     * @return Success
     */
    getUserById(employeeId: string | undefined): Observable<EmployeeListDto> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/GetUserById?";
        if (employeeId === null)
            throw new Error("The parameter 'employeeId' cannot be null.");
        else if (employeeId !== undefined)
            url_ += "employeeId=" + encodeURIComponent("" + employeeId) + "&";
    ...
    protected processGetUserById(response: HttpResponseBase): Observable<EmployeeListDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getAll(): Observable<EmployeeListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/EmployeeServices/GetAll";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetAll(response: HttpResponseBase): Observable<EmployeeListDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CreateEmployeeInput implements ICreateEmployeeInput {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.timePreference = _data["timePreference"];
    ...
    toJSON(data?: any) {
        ...
        data["timePreference"] = this.timePreference;
